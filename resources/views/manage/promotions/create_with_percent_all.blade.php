			...
			<form action="{{route('manage.promotions.store.with.percent.all')}}" method="post">
				...
				<div class="columns">
					<div class="column is-12">
						<div class="box">
							<div class="field">
								<labe class="label">ПРОЦЕНТ</labe>
								<div class="control has-icons-left">
									<input type="number" class="input" autocomplete="off" autofocus name="percent" value="{{ old('percent') }}" placeholder="ПРОЦЕНТ">
									<span class="icon is-left"><i class="fa fa-percent"></i></span>
								</div>
							</div>
							<div class="field">
