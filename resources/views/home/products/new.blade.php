@extends('main')
<?php
	$header = "НОВИ ПРОДУКТИ";
?>
@section('header', $header)
@section('title', '| НОВИ ПРОДУКТИ')

@section('content')
	<div class="columns is-multiline" id="orderPhone">
		<div class="column is-12 is-hidden-desktop p-t-20">
				...
				@foreach($products as $product)
					<div class="column is-one-fifth">
						<a href="{{route('slug', $product->slug)}}">
							<div class="card is-shadowless" style="border-bottom: 1px solid #ccc;">
